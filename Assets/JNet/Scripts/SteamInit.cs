...
public class SteamInit : MonoBehaviour {
	...
	private static SteamInit p_singleton;
	public static SteamInit m_singleton {
		get {
	...
	private bool p_InitializationSucceeded;
	public static bool m_InitializationSucceeded
    {
		get {
			return p_singleton.p_InitializationSucceeded;
		}
	}
	...
	private void Awake() {
        ...
        p_InitializationSucceeded = SteamAPI.Init();
		if (!p_InitializationSucceeded) {
